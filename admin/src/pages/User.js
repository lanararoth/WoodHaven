            ...
            <UserContainer>
                <ShowUser>
                    <ShowUserTop>
                        ...
                        />
                        <ShowTopTitle>
                            <FontWeight bolder>Jaseem</FontWeight>
                    ...
                    <ShowUserBottom>
                        ...
                        <UserShowInfo>
                            ...
                            <span className="showInfoTitle">Jaseem</span>
                        </UserShowInfo>
                        <UserShowInfo>
                        ...
                        <UserShowInfo>
                            ...
                            <span className="showInfoTitle">+91 9895106905</span>
                        </UserShowInfo>
                        <UserShowInfo>
                            <MailOutline className="showIcon" />
                            <span className="showInfoTitle">jaseem34@gmail.com</span>
                        </UserShowInfo>
                        <UserShowInfo>
                    ...
                    <UpdateForm>
                        <div>
                            ...
                            <UpdateItem>
                                ...
                                <input
                                    type="text"
                                    placeholder="jaseem34@gmail.com"
                                />
                            </UpdateItem>
                            <UpdateItem>
                                <label>Phone</label>
