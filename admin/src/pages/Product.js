    ...
    return (
        <ItemContainer>
            ...
            <ProductTopContainer>
                ...
                <TopRightContainer>
                    <InfoTopContainer>
                        <ItemShowImg mr src="/f1.jpg" alt="show-image" />
                        <span className="productName">Colourful printed Chairs</span>
                    </InfoTopContainer>
                    <InfoBottomContainer>
                        <InfoItemContainer>
                            <span>id:</span>
            ...
            <ProductBottomContainer>
                <ProductForm>
                    <FormLeft>
                        ...
                        <input type="text" placeholder="Modern armchair" />
                    ...
                    <FormRight>
                        <ItemUpload>
                            <ItemUploadImg src="/f2.jpg" alt="upload-img" />
                            <label for="file">
                                <Publish />
                            </label>
